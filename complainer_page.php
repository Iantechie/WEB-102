...
<body style="background-size: cover;
  ...
  <div>
    ...
    <div id="navbar" class="collapse navbar-collapse navside">
	...
	<div class="center-container">
		 <div class="bg-agile">
			...
			<div class="login-form"><p><h2 style="color:white">Welcome <?php echo "$u_name" ?></h2></p><br>
				...
				<form action="#" method="post" style="color: gray"><label style="color:white;">Huduma no.
					<input type="text"  name="aadhar_number" placeholder="Huduma Number" required="" disabled value=<?php echo "$a_no"; ?>>
					
				<div class="top-w3-agile" style="color: gray"><label style="color:white;">Location of Crime
             ...
             ?>
				...
				<div class="top-w3-agile" style="color: gray"> <label style="color:white;">Type of Crime
            ...
            <option>Missing Person</option>
					...
					<label style="color:white;">Date Of Crime :   
						<input style="background-color: #313131;color: white" type="date" name="d_o_c" required>
					</div>
					<br>
					<div class="top-w3-agile" style="color: gray">
					Description
						<textarea  name="description" rows="20" cols="50" placeholder="Describe the incident in details with time" id="desc" required></textarea>
					</div>
