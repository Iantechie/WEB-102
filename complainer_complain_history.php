...
<head>
    ...
    header("location:userlogin.php");
        ...
        $u_id=$_SESSION['u_id'];
        $swq = "SELECT a_no FROM user where u_id='$u_id'";
        $result1=mysqli_query($conn, $swq);
    ...
    if(isset($_POST['s2']))
    {
        if($_SERVER["REQUEST_METHOD"]=="POST")
        {
            ...
            $_SESSION['cid']=$cid;
            $sqw = "SELECT a_no FROM complaint where c_id='$cid'";
            $resu=mysqli_query($conn, $sqw);
...
<body style="background-color: #dfdfdf">
    ...
    <div>
        <form style="float: right; margin-right: 100px; margin-top: 65px;" method="post">
            <input type="text" name="cid" style="width: 250px; height: 30px; color: black;" placeholder=" Complain Id" id="ciid" required>
