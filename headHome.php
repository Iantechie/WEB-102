...
<body style="background-image: url(head.jpg); background-size: 100%;background-repeat: no-repeat;back">
  <div class="container">
 ...
 <div>
    <form style="margin-top: 10%; margin-left: 40%;" method="post">
      <input type="text" name="cid" style="width: 250px; height: 30px;" placeholder="Complaint Id" id="ciid" required>
        <div>
