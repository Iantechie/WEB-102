...
<body style="background-color: #dfdfdf">
 ...
 <div  style="margin-top: 10%;margin-left: 45%">
   <a href="police_add.php"><button type="button" name="add" value="Add Police Officers" class="btn btn-primary"></a>
 </div>
...
<?php
    ...
    <form style="margin-top: 5%; margin-left: 40%;" method="post">
      <input type="text" name="pid" style="width: 250px; height: 30px; background-color:white;" placeholder=" Police Id" id="ciid" required>
        <div>
      <button class="btn btn-danger" type="submit" value="Delete Police" name="s2" style="margin-top: 10px; margin-left: 9%;">
        </div>
    </form>
